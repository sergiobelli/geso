...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				$( "#consensoTrattamentoDati" ).buttonset();
			});
		...
		<form id="modulo_atleta" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
			<table border="0" cellpadding="3" cellspacing="1" class="FacetFormTABLE" align="center">
				...
				<tr>
					...
					<td class="FacetFormHeaderFont">
						<div id="sesso" align="right">
							<input type="radio" id="sessoM" name="sesso" value="M" <?php $sesso == 'M' ? print 'checked="checked" '  : '' ?> /><label for="sessoM">M</label>
							<input type="radio" id="sessoF" name="sesso" value="F" <?php $sesso == 'F' ? print 'checked="checked" '  : '' ?> /><label for="sessoF">F</label>
						</div>	
					</td>
				</tr
				<tr>
				...
				<tr>
					...
					<td class="FacetFormHeaderFont">
						<div id="consensoTrattamentoDati" align="right">
							<input type="radio" id="consensoTrattamentoDatiSI" name="consensoTrattamentoDati" value="S" <?php $consensoTrattamentoDati == 'S' ? print 'checked="checked" '  : '' ?> /><label for="consensoTrattamentoDatiSI">Si</label>
							<input type="radio" id="consensoTrattamentoDatiNO" name="consensoTrattamentoDati" value="N" <?php $consensoTrattamentoDati == 'N' || $consensoTrattamentoDati == '' ? print 'checked="checked" '  : '' ?> /><label for="consensoTrattamentoDatiNO">No</label>
						</div>	
					</td>
				</tr>
